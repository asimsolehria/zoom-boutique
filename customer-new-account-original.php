				...
				<tr>
					<td align="center">
						<table cellpadding="0" cellspacing="0" align="center" width="100%">
							<tr>
								<td align="center" class="mo-px-25" bgcolor="#F5F5F5" style="background-image: url(https://editor.liramail.com/images/feshto/feshto_pre/notification-thanks@hero.png);background-color:#F5F5F5;background-position:center top;background-size:cover;background-repeat: no-repeat;">
